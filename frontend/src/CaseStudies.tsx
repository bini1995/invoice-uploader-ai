...
const caseStudies = [
  {
    ...
    methodology: 'Based on ROI calculator projections using: 2,500 claims/month, $35/hr processor rate, 45-min avg manual processing, 6.2% error rate. Results represent projected annual savings with ClarifyOps at $4/claim (volume discounts applied for 500+ claims/month).'
  },
  {
    id: 'medical-billing',
    ...
    methodology: 'Based on ROI calculator projections using: 800 claims/month, $42/hr billing specialist rate, 30-min avg processing, 23% baseline denial rate. Results represent projected improvements with ClarifyOps at $4/claim (volume discounts applied for 500+ claims/month).'
  },
  {
    ...
    methodology: 'Based on ROI calculator projections using: 80 baseline claims/month growing to 240, $45/hr adjuster rate, 2.5 hrs admin time per claim. Results represent projected revenue gains with ClarifyOps at $4/claim (first 25 claims free every month).'
  }
];
