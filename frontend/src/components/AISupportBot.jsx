...
const KNOWLEDGE_BASE = {
  general: [
    ...
    { q: 'pricing', a: 'ClarifyOps is $4 per claim with the first 25 claims free every month. No subscriptions, no seat licenses, no annual contracts. Volume discounts are available for 500+ claims/month ($3.50/claim). We handle the annoying prep work so you can focus on adjusting. Contact us at clarifyops.com for high-volume pricing.' },
