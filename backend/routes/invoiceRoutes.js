...
router.patch('/:id/approve', authMiddleware, authorizeRoles('finance','admin'), approveInvoice);
...
router.patch('/bulk/approve', authMiddleware, authorizeRoles('finance','admin'), bulkApproveInvoices);
